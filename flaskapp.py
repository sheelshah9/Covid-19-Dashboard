...
def forecast_daily_cases(grouped_df, daily_df):
    ...
    data = []
    flag = True
    y_max = max(real_arima.max(), real_lstm.max(), real_xg.max())
...
data, y_max = forecast_daily_cases(grouped_df, daily_df)
...
app.layout = dbc.Container(fluid=True, children=[
    ...
    dbc.Row([
            ...
            dbc.Tabs([
                dbc.Tab([dcc.Graph(id="graph_daily_increase_US", figure=graph.draw_graph_daily_increase(data, y_max)),
                         dcc.Graph(id="Total_US", figure=graph.draw_graph_daily_increase(total_data, y_max_total))],
